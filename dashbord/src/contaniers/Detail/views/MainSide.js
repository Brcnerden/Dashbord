  ...
  return (
    <div>
      ...
      <div className="flex w-full justify-between">
        <div className=" py-3 font-medium text-[20px] w-[330px] leading-7">
        ...
        <div className="flex  w-[330px] mt-[12px] font-medium text-[20px] items-center leading-7 text-gray100">
