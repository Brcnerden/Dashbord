...
export const SideBar = () => {
  return (
    <div className='w-[260px] ml-[40px] mr-[80px]'>
        ...
        <Icons.LeftArrow/>
        <div className='font-normal text-[16px]  mr-[8px] ml-[15px] text-gray300'>Back to previous</div>
        </div>
        ...
        <div className=' my-[40px] flex'>
            <button className='font-medium rounded-[4px] text-[10px] leading-4 mr-[20px] px-[24px] py-[9px] bg-gradient-button text-gray100'>status</button>
            <button className=' font-medium rounded-[4px] text-[10px] leading-4 mr-[7px] px-[24px] py-[9px] bg-white100 text-gray100'>privacy</button>
        </div>
        <div className='flex items-center px-[12px] '>
            <Icons.Setting/>
            <div className=' font-normal text-[14px] leading-[20px] text-black opacity-85'>Settings</div>
            </div>
